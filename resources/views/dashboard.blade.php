                    ...
                    <table class="table table-flush align-middle mb-0">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar">
                                        <img class="avatar-img" src="backend/assets/img/projects/project-1.png" alt="..." />
                                    </div>
                                    <div class="ms-4">
                                        <div>Filters AI</div>
                            ...
                            <td>
                                <div class="d-flex align-items-center text-nowrap">
                                    <div class="avatar avatar-xs me-2">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-2.jpg" alt="..." />
                                    </div>
                                    Michael Johnson
                                </div>
                            </td>
                            <td>
                                <div class="avatar-group">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-3.jpg" alt="..." />
                                    </div>
                                    <div class="avatar avatar-xs">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-4.jpg" alt="..." />
                                    </div>
                                    <div class="avatar avatar-xs">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-5.jpg" alt="..." />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar">
                                        <img class="avatar-img" src="backend/assets/img/projects/project-2.png" alt="..." />
                                    </div>
                                    <div class="ms-4">
                            ...
                            <td>
                                <div class="d-flex align-items-center text-nowrap">
                                    <div class="avatar avatar-xs me-2">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-1.jpg" alt="..." />
                                    </div>
                                    Emily Thompson
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar-group">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img class="avatar-img" src="backend/assets/img/photos/photo-6.jpg" alt="..." />
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar">
                                        <img class="avatar-img" src="backend/assets/img/projects/project-3.png" alt="..." />
                                    </div>
                                    <div class="ms-4">
